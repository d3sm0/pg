...
class PG:
    def __init__(self, observation_space, action_space, h_dim):
        ...
        self.pi_opt = optim.Adam(self._agent.pi.parameters(), lr=config.learning_rate)
        self.value_opt = optim.Adam(self._agent.v.parameters(), lr=config.learning_rate, weight_decay=1e-3)
        self.data = []
