...
def main():
    ...
    for agent, agent_fn in agents.items():
        ...
        plot_batch(d_s, plot_fn=plot_ds, path=f"plots/shamdp/state_distribution_prob_{44}")
        plot_batch(advs, plot_fn=plot_adv, path=f"plots/shamdp/adv_{44}")
